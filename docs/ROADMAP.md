...
- **Suíte de automação (82 tools)** — crawl/map/index(BM25)/llmstxt, gather/ask, meta/product/images/media, batch, dataset, monitor+daemon, adapter (site→tool), workflow (replay determinístico).
